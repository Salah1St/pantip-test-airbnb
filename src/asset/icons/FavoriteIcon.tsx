...
function UserCircle({ className = "", size = "32px", color = "black" }: props) {
  return (
    <div className={`flex justify-center items-center ${className}`}>
      <svg fill={`${color}`} height={`${size}`} width={`${size}`} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <g>
          <g>
            <path
        ...
        <g>
          <g>
            <path
              d="M385.429,198.204l-79.088-11.492l-35.369-71.667c-6.114-12.386-23.828-12.388-29.943,0l-35.369,71.667l-79.088,11.492
